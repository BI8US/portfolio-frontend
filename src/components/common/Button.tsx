...
export const Button: React.FC<ButtonProps> = ({
    ...
    switch (type) {
        case 'secondary':
            typeClasses =
                'bg-content text-button-secondary border-button-secondary ' +
        ...
        case 'danger':
            typeClasses =
                'bg-content text-button-danger border-button-danger ' +
        ...
        default:
            typeClasses =
                'bg-content text-button-primary border-button-primary ' +
